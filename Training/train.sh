...
export MODEL="/home/ubuntu/Insight/Vulnerable_Buildings/Models/inception_model.h5"

#The location to save the trained model
export TRAINED_MODEL="/home/ubuntu/Insight/Vulnerable_Buildings/Models/inception_model_trained.h5"
